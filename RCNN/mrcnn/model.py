...
class MaskRCNN(object):
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        # print(self.get_trainable_layers())
    ...
    def return_layer(self,l):

        return self.keras_model.layers[l].output

    def print_weights(self,l):
        ...
        filters = self.keras_model.layers[l].get_weights()
        print(filters)
        print(len(filters))
        print(len(filters[0]))
    ...
    def get_trainable_layers(self):
        ...
        for l in self.keras_model.layers:
            ...
            #     if not not l.get_weights():
            #         filters = l.get_weights()
            #         # print(filters)
